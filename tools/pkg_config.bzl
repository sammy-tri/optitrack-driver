...
# Based on commit 4b3a4a5daf2cb24477582acbbb4741d35ed192e7 of
# https://github.com/RobotLocomotion/drake/blob/master/tools/workspace/pkg_config.bzl

_DEFAULT_TEMPLATE = Label("//tools:pkg_config.BUILD.tpl")
...
Args:
    ...
    licenses: (Optional) Licenses of the library target.
